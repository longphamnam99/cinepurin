<template>
  ...
  <div class="bg-gradient-to-tr from-[#4E0045] to-[#23001C] relative">
    ...
    <div class="grid grid-cols-5 w-[1280px] text-center justify-center pt-4 pl-24">
      <div class="">
        <div
          class="bg-white bg-opacity-10 px-4 py-2 font-avantgarde-demi text-white text-sm uppercase text-center mb-2 inline-block">
  ...
  <div class="flex bg-black justify-center">
    <div>
      <div>
        <p class="text-white text-center text-sm">CÔNG TY CỔ PHẦN GIẢI TRÍ PHÁT HÀNH PHIM – RẠP CHIẾU PHIM NGÔI SAO <br>
        </p>
