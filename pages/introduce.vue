...
<template>
    ...
    <div class="relative z-10 tabs-panel">
      <tabs ref="tabsref" variant="default" v-model="activeTab">
        <tab name="first" title="Hệ Thống CinePurin ">
            <div>
                <div class="flex justify-center py-3 gap-2">
                    <div >
                        <div class="intro-pic">
                            <img src="../public/images/ld.jpg" alt="" class="h-[300px] w-[300px] block rounded-full">
                        </div>
                    </div>
                    <div class="pt-16">
                        <div class="w-[600px] ">
                            <h2 class="bg-pink-100 w-40 text-3xl rounded-xl font-bold py-2"> Cine Purin</h2>
                            <p class="pt-2 text-white">Địa chỉ : Tầng 4, Trung tâm Thương mại và Dịch vụ Tài chính Sacombank, 713 Quốc lộ 20, thị trấn Liên Nghĩa, huyện Đức Trọng, tỉnh Lâm Đồng.
        ...
        <tab name="third" title="Công Nghệ Phòng Chiếu">
          <div class="bg-[#f18720] relative">
            <div
    ...
    <div class="py-5">
        <div>
            <h1 class="text-white text-center font-bold text-2xl">Đến Ngay CinePurin để trải nghiệm các dịch vụ tốt nhất!!!</h1>
        </div>
    </div>
    </div>
